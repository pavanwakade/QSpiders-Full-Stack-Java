...
public class Github {
    ...
    private static void showPopup(String title, String message) {
        SwingUtilities.invokeLater(() -> {
            ...
            // Initialize fadeOutTimer first so it can be referenced inside the lambda
            Timer fadeOutTimer = new Timer(50, null);
            
            // Now set the ActionListener for fadeOutTimer
            ...
            Timer closeTimer = new Timer(5000, e -> fadeOutTimer.start());
    ...
    private static void scheduleRepositoryMonitoring() {
        ...
        monitoredRepositories.forEach(repoPath -> {
