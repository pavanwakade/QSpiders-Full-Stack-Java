...
public class PowerOfTwoMaxHeap<T extends Comparable<T>> {
    ...
    private final int childrenPower;  // e.g. if 2, each node has 2^2 = 4 children
    private final int numChildren;    // equals 2^childrenPower
    ...
    public class Main {
        public static void main(String[] args) {
            PowerOfTwoMaxHeap<Integer> heap = new PowerOfTwoMaxHeap<>(2); // 4-ary heap
