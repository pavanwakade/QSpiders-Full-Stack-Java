...
public class AllMethodsInOne {
	...
	public static void main(String[] args) {
		...
		String s = "Hello good Morning myname is pavan i have my BE in Electronics and Telecommunications";
		/**
		...
		/**
		 * 4)codePointBefour(index) -->int
		 * it ptint the ASCCI value of befour specific index
		 */
