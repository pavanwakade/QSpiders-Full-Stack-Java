...
mathWizard(5, 3, (x, y) => x + y);

// 4. Decision Maker
function decide(isHappy, yesCallback, noCallback) {
    isHappy ? yesCallback() : noCallback();
}
decide(true, () => console.log("Yay!"), () => console.log("Oh no!"));

// 5. Double the Fun
function doubleFun(num, callback) {
...
complimentMachine("Sam", (name) => `${name}, you are awesome!`);
